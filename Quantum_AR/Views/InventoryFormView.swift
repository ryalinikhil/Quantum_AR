...
struct InventoryFormView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog("Capture AR Model", isPresented: $vm.showUSDZSource, titleVisibility: .visible, actions: {
            ...
            Button("Room Capture") {  
                    ...
                    .alert(isPresented: $showingAlert) {
                        Alert(
                            ...
                            message: Text("This feature will be available in future updates."),
